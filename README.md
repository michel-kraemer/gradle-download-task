...
```groovy
plugins {
    id "de.undercouch.download" version "5.0.3"
}
```
...
task downloadZipFile(type: Download) {
    src 'https://github.com/michel-kraemer/gradle-download-task/archive/refs/tags/5.0.3.zip'
    dest new File(buildDir, '5.0.3.zip')
}
